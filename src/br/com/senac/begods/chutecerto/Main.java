...
public class Main {
    ...
    public static final String[] PERGUNTAS = {
            "Qual objeto os jogadores usam para jogar futebol?",
            "Qual é a cor do gramado do campo de futebol?",
            "O que o jogador precisa fazer para marcar ponto no futebol?",
            "Qual jogador pode pegar a bola com as mãos?",
            "Quantos jogadores entram em campo em cada time?",
            "Qual país ganhou mais Copas do Mundo?",
            "O que o juiz usa para chamar atenção durante o jogo?",
            "Qual competição reúne seleções de vários países?",
            "Uma partida tem 90 minutos. Se o juiz acrescentou mais 5 minutos, quanto tempo durou o jogo?",
            "Qual animal é conhecido por gostar de brincar com bola?",
            "Se um time fez 2 gols e o outro fez 1, quem venceu?",
            "Qual parte do corpo não pode usar para jogar futebol?",
            "O que os jogadores usam nos pés?",
            "Se uma bola é redonda, qual forma ela tem?",
            "Onde fica o goleiro durante o jogo?",
            "O que os torcedores fazem quando o time marca gol?",
            "Quantos gols existem em um campo de futebol?",
            "Qual destas cores aparece na bandeira do Brasil?",
            "O que acontece quando a bola entra no gol?",
            "Se um jogador tem 3 figurinhas da Copa e ganha mais 2, com quantas ele fica?"
    };
	...
	public static final String[][] ALTERNATIVAS = {
			{"Livro", "Bicicleta", "Pipa"},
			{"Azul", "Vermelho", "Rosa"},
			{"Pular", "Correr", "Assobiar"},
			{"Atacante", "Zagueiro", "Juiz"},
			{"7", "20", "5"},
			{"Chile", "Japão", "Canadá"},
			{"Tambor", "Flauta", "Violão"},
			{"Olimpíadas de natação", "Corrida de bicicleta", "League of Legends World Championship"},
			{"90 Minutos", "100 Minutos", "85 Minutos"},
			{"Peixe", "Galinha", "Formiga"},
			{"O time com 1 Gol", "Empatou", "Ninguém"},
			{"Pé", "Cabeça", "Joelho"},
			{"Chinelo", "Tenis", "Sandália"},
			{"Quadrada", "Triangular", "Retangular"},
			{"Na Cozinha", "No Meio do Campo", "Na Arquibancada"},
			{"Dormem", "Ficam em Silêncio", "Saem correndo"},
			{"1", "3", "4"},
			{"Roxo", "Rosa", "Cinza"},
			{"Escanteio", "Falta", "Intervalo"},
			{"3 Figurinhas", "4 Figurinhas", "6 Figurinhas"}
	};
